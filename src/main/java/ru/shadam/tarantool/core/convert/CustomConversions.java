...
public class CustomConversions {
    ...
    /**
     * Returns whether we have a custom conversion registered to readTargetWriteLocl into a Tarantool native type. The
    ...
    static class ConverterRegistration {
        ...
        /**
         * Returns whether the source type is a Tarantool simple one.
         *
         * @return
         */
        public boolean isSimpleSourceType() {
            return isTarantoolBasicType(convertiblePair.getSourceType());
        }

        /**
         * Returns whether the target type is a Tarantool simple one.
         *
         * @return
         */
        public boolean isSimpleTargetType() {
            return isTarantoolBasicType(convertiblePair.getTargetType());
        }
